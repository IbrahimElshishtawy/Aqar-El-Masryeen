...
class LocaleService extends GetxController {
  LocaleService(this._localCacheService);
  ...
  Future<void> loadSavedLocale() async {
    final code = await _localCacheService.readString(StorageKeys.localeCode);
  ...
  Future<void> changeLocale(Locale locale) async {
    ...
    await _localCacheService.writeString(StorageKeys.localeCode, locale.languageCode);
