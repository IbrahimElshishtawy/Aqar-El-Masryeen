...
class _ExpenseFormSheetState extends ConsumerState<ExpenseFormSheet> {
    ...
    await ref
        ...
        .create(
          ...
          title: widget.expense == null
              ...
              : 'تم تحديث المصروف',
          body:
              '${expense.description} • ${expense.amount.toStringAsFixed(0)} جنيه',
  ...
  Widget build(BuildContext context) {
    return AppFormSheet(
      title: widget.expense == null ? 'إضافة مصروف' : 'تعديل المصروف',
      child: Form(
        key: _formKey,
        child: Column(
          children: [
            TextFormField(
              ...
              validator: (value) =>
                  (value ?? '').trim().isEmpty ? 'أدخل وصفًا.' : null,
            ),
            ...
            InkWell(
              ...
              child: InputDecorator(
                decoration: const InputDecoration(labelText: 'تاريخ المصروف'),
                child: Row(
                  children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'رابط اختياري من Firebase Storage أو رابط مباشر',
              ),
            ),
            const SizedBox(height: 12),
            TextFormField(
            ...
            SizedBox(
              ...
              child: FilledButton(
                ...
                child: Text(_saving ? 'جار الحفظ...' : 'حفظ المصروف'),
              ),
            ),
          ],
        ),
